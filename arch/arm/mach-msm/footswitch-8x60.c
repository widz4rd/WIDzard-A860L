...
#include "clock.h"
#include <mach/rpm.h>	//	Fixed CASE: 01114218 by Qualcomm
#include "footswitch.h"

#include "rpm_resources.h"	//	Fixed CASE: 01114218 by Qualcomm
...
#define DEFAULT_RESET_DELAY_US	1		//	Fixed CASE: 01114218 by Qualcomm
...
struct footswitch {
	...
	struct clk		*core_clk;
	unsigned long		reset_delay_us;			//	Fixed CASE: 01114218 by Qualcomm
};
...
static int footswitch_enable(struct regulator_dev *rdev)
{
	...
	udelay(fs->reset_delay_us);		//	Fixed CASE: 01114218 by Qualcomm
...
static int footswitch_disable(struct regulator_dev *rdev)
{
	...
	//	Fixed CASE: 01114218 by Qualcomm
...
static struct footswitch footswitches[] = {
	...
	FOOTSWITCH(FS_GFX3D_8064, "fs_gfx3d", &gfx3d_8064_fs_ops,GFX3D_GFS_CTL_REG),	//	Fixed CASE: 01114218 by Qualcomm
...
static int footswitch_probe(struct platform_device *pdev)
{
	...
	fs->reset_delay_us =
		driver_data->reset_delay_us ? : DEFAULT_RESET_DELAY_US;		//	Fixed CASE: 01114218 by Qualcomm
