...
#if (defined(CONFIG_MACH_APQ8064_EF51S)||defined(CONFIG_MACH_APQ8064_EF51K)||defined(CONFIG_MACH_APQ8064_EF51L)||defined(CONFIG_MACH_APQ8064_EF52S)||defined(CONFIG_MACH_APQ8064_EF52K)||defined(CONFIG_MACH_APQ8064_EF52L))
		.start	= 11,
		.end	= 11,
#else
...
static struct fs_driver_data gfx3d_fs_data = {
	.clks = (struct fs_clk_data[]){
		{ .name = "core_clk", .reset_rate = 1800000 },		//	Fixed CASE: 01114218 by Qualcomm
		{ .name = "iface_clk" },
		{ .name = "bus_clk" },
		{ 0 }
	},
	.reset_delay_us = 10,								//	Fixed CASE: 01114218 by Qualcomm
...
struct platform_device *apq8064_footswitch[] __initdata = {
	...
	FS_8X60(FS_GFX3D_8064,  "vdd",	"kgsl-3d0.0",	&gfx3d_fs_data),		//	Fixed CASE: 01114218 by Qualcomm
