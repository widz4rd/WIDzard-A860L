...
#if defined(MDP4_ERROR) || defined(CONFIG_SKY_EF52S_BOARD)||defined(CONFIG_SKY_EF52K_BOARD)||defined(CONFIG_SKY_EF52L_BOARD) //shkwak 20121130, ef52 mipi cmd mode need mdp4_sw_reset 
	/*
